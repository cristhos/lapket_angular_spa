...
var RegisterFinalFormComponent = (function () {
    function RegisterFinalFormComponent(userService, countryService, cityService, router) {
        ...
        this.model = new register_final_form_1.RegisterFinalFormModel(null, null, null, null, null);
    ...
    RegisterFinalFormComponent.prototype.onSubmit = function () {
        ...
        this.userService.putUser(this.model).subscribe(function (data) {
            ...
            console.log(error);
            _this.model = new register_final_form_1.RegisterFinalFormModel(_this.model.fullName, _this.model.country, _this.model.city, _this.model.gender, _this.model.phone_number);
        }, function () {
            console.log("finish");
        });
        this.loading = false;
...
//# sourceMappingURL=/home/lithos/Data/Lab/codash/angularSpa/ts-node-94a6b447580330f9f2b609422537b04239ff3a39df9137e32efd559f1a2935cb/d3e27bfe51aea66a52b66f03f6ab10277b7cce60278332573a1495c184e03846/5d77567ce95ededaf38160b2d3470b9a4ffc3600780dcfa43194713276a6fea5.js.map